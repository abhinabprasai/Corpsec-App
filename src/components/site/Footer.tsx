    ...
    <footer className="footer">
      ...
      <div className="container foot-top">
        ...
        <div className="foot-sub">
          ...
          <form className="foot-sub-bar" id="footSub" autoComplete="off" onSubmit={handleSubmit}>
            <input type="email" id="footSubInput" placeholder={t("footer.emailPlaceholder")} aria-label={t("footer.emailLabel")} data-slot="input" value={email} onChange={(e) => setEmail(e.target.value)} />
          ...
          <span className="foot-sub__note" id="footSubNote">{subscribed ? t("footer.subSuccess") : t("footer.subNote")}</span>
        </div>
      </div>
      ...
      <div className="container foot-cols">
        <div className="foot-col">
          ...
          <button type="button" onClick={() => open()}>{t("footer.links.gabriellaAdvisor")}</button>
          <Link to="/jurisdictions">{t("footer.links.allJurisdictions")}</Link>
          <Link to="/compare">{t("footer.links.compareJurisdictions")}</Link>
          <Link to="/#backoffice">{t("footer.links.companyFormation")}</Link>
          <Link to="/#pricing">{t("footer.links.pricing")}</Link>
        </div>
        <div className="foot-col">
          <h4>{t("footer.cols.solutions")}</h4>
          <button type="button" onClick={() => open()}>{t("footer.links.saas")}</button>
          <button type="button" onClick={() => open()}>{t("footer.links.holding")}</button>
          <button type="button" onClick={() => open()}>{t("footer.links.ecommerce")}</button>
          <button type="button" onClick={() => open()}>{t("footer.links.crypto")}</button>
          <button type="button" onClick={() => open()}>{t("footer.links.solo")}</button>
        </div>
        <div className="foot-col">
          <h4>{t("footer.cols.resources")}</h4>
          <Link to="/jurisdictions">{t("footer.links.guides")}</Link>
          <Link to="/compare">{t("footer.links.compareJurisdictions")}</Link>
          <Link to="/#how">{t("footer.links.howItWorks")}</Link>
          <Link to="/#faq">{t("footer.links.helpCenter")}</Link>
        </div>
        <div className="foot-col">
          <h4>{t("footer.cols.company")}</h4>
          <Link to="/about">{t("footer.links.about")}</Link>
          <Link to="/about#team">{t("footer.links.team")}</Link>
          <Link to="/contact">{t("footer.links.contact")}</Link>
          <Link to="/contact">{t("footer.links.sales")}</Link>
        </div>
        <div className="foot-col">
          <h4>{t("footer.cols.legal")}</h4>
          <Link to="/#">{t("footer.links.terms")}</Link>
          <Link to="/#">{t("footer.links.privacy")}</Link>
          <Link to="/#">{t("footer.links.cookies")}</Link>
